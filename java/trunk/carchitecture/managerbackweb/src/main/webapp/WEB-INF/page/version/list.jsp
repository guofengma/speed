...
<body>
	<form action="${ctx }/version/list.do" id="submit-form">
	<div class="page-body">
		<div class="row">
			<div class="col-xs-12 col-md-12">
				<div class="widget">
					<div class="widget-header ">
						<span class="widget-caption">版本信息管理</span>
					</div>
					<%-- <div class="widget-body">
                      ...
                      <div class="table-toolbar">
						<a id="editabledatatable_new" href="${ctx }/version/add.do"
							class="btn btn-default">添加版本信息</a>
					</div>
...
<script src="${ctx }/js/version/list.js"></script>
</body>
