...
import com.speed.dao.BaseDao;
import com.speed.model.Entity;
import com.speed.model.Entity.Criteria;
import com.speed.model.Entity.PrimaryKey;
import com.speed.model.Entity.SimpleCriteria;
...
public class BaseDaoImpl<K extends Serializable, E extends Entity> implements BaseDao<K, E> {
	...
	protected String statement(String id) {
		return String.format("com.speed.dao.%sDao.%s", entityClass.getSimpleName(), id);
	}
