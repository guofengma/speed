...
public class ErrorCode {
	...
	public static final ErrorCode RUNTIME_EXCEPTION_HANDLER= new ErrorCode(100008, "[服务器]运行时异常");
	...
	/**密码不一致*/
	public static final ErrorCode CUSTOM_PHONE_NOT_DIFFERENT  = new ErrorCode(200021, "两次密码不一致");
	/**账号或密码错误或冻结*/
	public static final ErrorCode CUSTOM_USER_PWD_ERROR_LOCK  = new ErrorCode(200005, "账号或密码错误或冻结");
