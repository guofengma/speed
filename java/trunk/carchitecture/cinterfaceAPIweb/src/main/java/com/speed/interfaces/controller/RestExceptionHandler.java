...
import com.speed.util.CustomException;
...
//    @ResponseBody  
//    public JsonResult runtimeExceptionHandler(RuntimeException runtimeException) {  
//        return new JsonResult(ErrorCode.RUNTIME_EXCEPTION_HANDLER);
//    }  
