(function(){
    // 设置上下滚动效果
    (function(){
        let height = ($('.dynamic_trade_list').height() - $('.dynamic_trade_list').find('li:first').height()) * -1;
    ...
    // 设置左右滚动效果
    (function(){
        let width = ($('.basic_info_store_name').width() - 30) * -1;
    ...
    $('.newsfeed_ads_box').on('click','.newsfeed_ads_item',function(){
        ...
        switch (index) {
            case 0:
                window.location.href = './../../html/common/today_push.html'
                break;
            case 1:
                window.location.href = './../../html/common/sales_campaign.html'
                break;
            default:
                window.location.href = './../../html/common/latest_activity.html'
                break;
        }
    })
