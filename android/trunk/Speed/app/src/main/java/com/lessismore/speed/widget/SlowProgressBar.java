package com.lessismore.speed.widget;
...
import com.lessismore.speed.util.DensityUtils;

public class SlowProgressBar extends View {
    ...
    public SlowProgressBar(Context context) {
        this(context, null);
    }

    public SlowProgressBar(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SlowProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (widthMode == MeasureSpec.EXACTLY) {
            ...
            mWidth = DensityUtils.dp2px(mContext, 300);
        ...
        if (heightMode == MeasureSpec.EXACTLY) {
            ...
            mHeight = DensityUtils.dp2px(mContext, mDefaultHeight);
        }
